...
public class RadioButtonTesting extends Base_Test_problem{ 
	
	@Test
	public void RadioButtonTesting() throws InterruptedException
	{
		By radioButtonsBlockLocator=By.xpath("/html/body/div[2]/table[9]/tbody/tr/td[4]/table/tbody/tr/td/div/span/form/table[3]/tbody/tr/td/table/tbody/tr/td");
